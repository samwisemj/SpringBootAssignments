...
//		
	...
	public Resource<Customer> getById(@PathVariable(value="id")int id) throws CustomerNotFoundException
	{
		Resource<Customer> resource=new Resource(service.findById(id));
